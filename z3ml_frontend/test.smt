...
(define-fun sum.2548 ((-q60 Type) (-p60 Type) (-o60 Type) (-n60 Type) (-m60 Type) (-l60 Type) (-k60 Type) (-j60 Type) (-i60 Type) (-h60 Type) (-g60 Type) (-f60 Type) (-d60 Type) (-c60 Type) (-b60 Type) (-y59 Type) (-x59 Type) (-w59 Type)) Bool (=> T10 (and (= -w59 -x59) (=> T9 (and (= -x59 (-> -q60 -p60)) (= -y59 -q60) (= -c60 -p60) (= -d60 -q60) (= -i60 -p60) (=> T4 (and (= -j60 (-> -m60 -i60)) (= -k60 (-> -l60 -j60)) (=> T1 (and (= -n60 (-> -o60 -m60)) (=> T0 (= -o60 -g60)) (=> T2 (= -n60 -w59)))) (=> T3 (= -k60 (-> int (-> int int)))) (=> T5 (= -l60 -f60)))) (=> T6 (and (= -d60 (list -h60)) (= -h60 -f60) (= (list -h60) -g60))) (=> T7 (= int -c60)) (=> T8 (= -y59 (list -b60))))))))
(assert (=> T10 (and (sum.2548 -r60 -s60 -t60 -u60 -v60 -w60 -x60 -y60 -a61 -b61 -c61 -d61 -e61 -f61 -g61 -h61 -i61 -j61) (=> T9 (and (=> T4 (and (=> T1 (and true true)) true true)) true true true)))))
